...
The system is highly vulnerable and can be fully controlled by attackers. Immediate action is required to fix security issues.

## ✅ Result

Full attack lifecycle successfully executed.
